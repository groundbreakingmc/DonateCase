...
[![API](https://repo.jodex.xyz/api/badge/latest/releases/com/jodexindustries/donatecase/api?color=40c14a&name=API&prefix=v)](https://wiki.jodex.xyz/docs/DonateCase/API/install)
...
```
```groovy
compileOnly("com.jodexindustries.donatecase:spigot-api:2.1.0.7")
```
